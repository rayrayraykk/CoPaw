...
export const i18n: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "quickstart.optionLocal": "无需手动配置 Python，一行命令自动完成安装",
    "quickstart.badgeRecommended": "推荐",
    "quickstart.badgeBeta": "Beta",
    "quickstart.optionPip": "适合自行管理 Python 环境的用户",
    ...
    "quickstart.optionDocker": "使用官方镜像，支持 Docker Hub / 阿里云 / 魔搭",
  ...
  en: {
    ...
    "quickstart.optionLocal":
      "No Python setup required, one command installs everything",
    "quickstart.badgeRecommended": "Recommended",
    "quickstart.badgeBeta": "Beta",
    "quickstart.optionPip": "If you prefer managing Python yourself",
