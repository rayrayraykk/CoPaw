...
LangString qwenpawCliPathPageSubtitle ${LANG_SIMPCHINESE} "选择是否让终端可以直接使用 qwenpaw-core。"
LangString qwenpawCliPathPageDescription ${LANG_SIMPCHINESE} "这会把随包提供的 qwenpaw-core 命令加入你的用户 PATH。之后可通过重新安装或卸载 QwenPaw Desktop 变更。"
LangString qwenpawCliPathCheckbox ${LANG_SIMPCHINESE} "将 qwenpaw-core 添加到 PATH"
LangString qwenpawCliPathAdded ${LANG_SIMPCHINESE} "已将 qwenpaw-core 添加到用户 PATH"
LangString qwenpawCliPathSkipped ${LANG_SIMPCHINESE} "已跳过添加 qwenpaw-core 到用户 PATH"
LangString qwenpawCliPathMissing ${LANG_SIMPCHINESE} "未找到 qwenpaw-core.exe，已跳过 PATH 更新"
