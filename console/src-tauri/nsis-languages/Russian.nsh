...
LangString qwenpawCliPathPageSubtitle ${LANG_RUSSIAN} "Choose whether qwenpaw-core is available in terminals."
LangString qwenpawCliPathPageDescription ${LANG_RUSSIAN} "This adds the bundled qwenpaw-core command to your user PATH. You can change it later by reinstalling or uninstalling QwenPaw Desktop."
LangString qwenpawCliPathCheckbox ${LANG_RUSSIAN} "Add qwenpaw-core to PATH"
LangString qwenpawCliPathAdded ${LANG_RUSSIAN} "Added qwenpaw-core to user PATH"
LangString qwenpawCliPathSkipped ${LANG_RUSSIAN} "Skipped adding qwenpaw-core to user PATH"
LangString qwenpawCliPathMissing ${LANG_RUSSIAN} "qwenpaw-core.exe was not found; skipped PATH update"
