...
LangString qwenpawCliPathPageSubtitle ${LANG_JAPANESE} "Choose whether qwenpaw-core is available in terminals."
LangString qwenpawCliPathPageDescription ${LANG_JAPANESE} "This adds the bundled qwenpaw-core command to your user PATH. You can change it later by reinstalling or uninstalling QwenPaw Desktop."
LangString qwenpawCliPathCheckbox ${LANG_JAPANESE} "Add qwenpaw-core to PATH"
LangString qwenpawCliPathAdded ${LANG_JAPANESE} "Added qwenpaw-core to user PATH"
LangString qwenpawCliPathSkipped ${LANG_JAPANESE} "Skipped adding qwenpaw-core to user PATH"
LangString qwenpawCliPathMissing ${LANG_JAPANESE} "qwenpaw-core.exe was not found; skipped PATH update"
