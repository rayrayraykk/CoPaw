...
LangString qwenpawCliPathPageSubtitle ${LANG_PORTUGUESEBR} "Choose whether qwenpaw-core is available in terminals."
LangString qwenpawCliPathPageDescription ${LANG_PORTUGUESEBR} "This adds the bundled qwenpaw-core command to your user PATH. You can change it later by reinstalling or uninstalling QwenPaw Desktop."
LangString qwenpawCliPathCheckbox ${LANG_PORTUGUESEBR} "Add qwenpaw-core to PATH"
LangString qwenpawCliPathAdded ${LANG_PORTUGUESEBR} "Added qwenpaw-core to user PATH"
LangString qwenpawCliPathSkipped ${LANG_PORTUGUESEBR} "Skipped adding qwenpaw-core to user PATH"
LangString qwenpawCliPathMissing ${LANG_PORTUGUESEBR} "qwenpaw-core.exe was not found; skipped PATH update"
