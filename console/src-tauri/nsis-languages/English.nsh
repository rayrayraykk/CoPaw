...
LangString qwenpawCliPathPageSubtitle ${LANG_ENGLISH} "Choose whether qwenpaw-core is available in terminals."
LangString qwenpawCliPathPageDescription ${LANG_ENGLISH} "This adds the bundled qwenpaw-core command to your user PATH. You can change it later by reinstalling or uninstalling QwenPaw Desktop."
LangString qwenpawCliPathCheckbox ${LANG_ENGLISH} "Add qwenpaw-core to PATH"
LangString qwenpawCliPathAdded ${LANG_ENGLISH} "Added qwenpaw-core to user PATH"
LangString qwenpawCliPathSkipped ${LANG_ENGLISH} "Skipped adding qwenpaw-core to user PATH"
LangString qwenpawCliPathMissing ${LANG_ENGLISH} "qwenpaw-core.exe was not found; skipped PATH update"
